...
class Configuration:
    ...
    def __str__(self):
        return "pieces = " + str(self.pos) #+", "+str(self.direction)
...
class AgentState:
    ...
    def __str__( self ):
        if self.isPlayer:
            ...
            return "Opponent: " + str( self.configuration )
    ...
    def getPieces(self):
        ...
        return self.configuration.getPieces()
...
class GameStateData:
    ...
    def __str__( self ):
        ...
        for x in range(width):
            for y in range(height):
                ...
                map[x][y] = self._foodWallStr(walls[x][y])
    ...
    def initialize( self, layout ):
        ...
        self.agentStates = []
        # numGhosts = 0
        for isPlayer, pos in layout.agentPositions:
            if not isPlayer:
                # if numGhosts == numGhostAgents: continue # Max ghosts reached already
                # else: numGhosts += 1
            self.agentStates.append( AgentState( Configuration(pieces), isPlayer) )
