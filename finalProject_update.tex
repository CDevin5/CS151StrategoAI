...
At this time, we have completed a working Stratego game, as well as an agent that takes human input so that we can play the game, and an agent that makes random moves, so that we have something to compare our learning agent to. 
\\
