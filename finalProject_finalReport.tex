...
\section{Evaluation}
We were successful in writing a Stratego game from scratch, and getting it to be playable by both humans and computer agents.
We were also successful in getting the learning agent to play better than the random agent, as our learning agent consistently wins more than 50\% of the games that it plays against the random agent.\\
